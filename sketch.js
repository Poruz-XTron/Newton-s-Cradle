...
bob2 = Bodies.circle(330,400,40,bob_options);
World.add(world,bob2);
bob3 = Bodies.circle(350,400,40,bob_options);
  World.add(world,bob3);
bob4 = Bodies.circle(370,400,40,bob_options);
...
Engine.update(engine);
  ...
  //call display() to show ropes here
   ...
   //write line( ) code below to show line between roof and boob
